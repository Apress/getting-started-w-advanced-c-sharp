using System;
namespace EventEx3DotNetFramework
{
    ...
    class Sender
    {
        ...
        protected virtual void OnMyIntChanged()
        {
            ...
            ////updated code used for testing( Refer the discussion prior to Demonstration4)
            //// if (MyIntChanged != null)
            //if (myIntChanged != null)
            //{   //Combine your data with the event argument
            //    JobNoEventArgs jobNoEventArgs = new JobNoEventArgs();
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("***Demonstration-3.Passing data in the event argument.***");
            ...
            //Unregistering now
            sender.MyIntChanged -= receiver.GetNotificationFromSender;
            //Though sender keep sending notifications, but the receiver will not receive 
